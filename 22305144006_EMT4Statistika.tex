...
\end{eulerprompt}
\eulerimg{15}{images/22305144006_EMT4Statistika-001.png}
\begin{eulercomment}
...
menghitung distribusi probabilitas kumulatif (DPK).
...
\end{eulerprompt}
\eulerimg{15}{images/22305144006_EMT4Statistika-003.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/22305144006_EMT4Statistika-005.png}
\eulerheading{Tabel}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/22305144006_EMT4Statistika-006.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/22305144006_EMT4Statistika-007.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/22305144006_EMT4Statistika-008.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/22305144006_EMT4Statistika-011.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/22305144006_EMT4Statistika-012.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/22305144006_EMT4Statistika-013.png}
\begin{eulerformula}
\[
\text{normaldis(x,m,d)}=\int_{-\infty}^x \frac{1}{d\sqrt{2\pi}}e^{-\frac{1}{2}(\frac{t-m}{d})^2}\ dt.
\]
...
\end{eulerprompt}
\eulerimg{15}{images/22305144006_EMT4Statistika-016.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/22305144006_EMT4Statistika-017.png}
\begin{eulercomment}
...
>statplot(YT,BT1,"b"):
\end{eulerprompt}
\eulerimg{15}{images/22305144006_EMT4Statistika-019.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{15}{images/22305144006_EMT4Statistika-020.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/22305144006_EMT4Statistika-021.png}
\begin{eulercomment}
...
>  angle=30°,ccols=CP):
\end{eulerprompt}
\eulerimg{15}{images/22305144006_EMT4Statistika-022.png}
\begin{eulercomment}
...
>shrinkwindow():
\end{eulerprompt}
\eulerimg{15}{images/22305144006_EMT4Statistika-023.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/22305144006_EMT4Statistika-024.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/22305144006_EMT4Statistika-025.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/22305144006_EMT4Statistika-026.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/22305144006_EMT4Statistika-027.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/22305144006_EMT4Statistika-028.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/22305144006_EMT4Statistika-029.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/22305144006_EMT4Statistika-030.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{15}{images/22305144006_EMT4Statistika-031.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/22305144006_EMT4Statistika-032.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/22305144006_EMT4Statistika-033.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/22305144006_EMT4Statistika-034.png}
...
>figure(0):
\end{eulerprompt}
\eulerimg{15}{images/22305144006_EMT4Statistika-035.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/22305144006_EMT4Statistika-036.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/22305144006_EMT4Statistika-037.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/22305144006_EMT4Statistika-038.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/22305144006_EMT4Statistika-040.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/22305144006_EMT4Statistika-041.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/22305144006_EMT4Statistika-042.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{15}{images/22305144006_EMT4Statistika-043.png}
\eulerheading{Tes}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/22305144006_EMT4Statistika-044.png}
\begin{eulerprompt}
>t=count(R,21);
\end{eulerprompt}
\begin{eulercomment}
...
\end{euleroutput}
\begin{eulercomment}
ni berarti, kami menolak hipotesis nilai rata-rata yang sama. Kami
...
\end{euleroutput}
\begin{eulercomment}
ekarang mari kita coba mensimulasikan dua perawatan a dan b yang
...
\end{eulerprompt}
\eulerimg{15}{images/22305144006_EMT4Statistika-045.png}
\begin{eulercomment}
Menghapus data.
\end{eulercomment}
\begin{eulerprompt}
...
\begin{eulercomment}
Pada bagian pengantar R terdapat sebuah contoh yang disebut sebagai
faktor.
...
>statplot(u,f,"h"):
\end{eulerprompt}
\eulerimg{15}{images/22305144006_EMT4Statistika-046.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/22305144006_EMT4Statistika-047.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/22305144006_EMT4Statistika-048.png}
\eulerheading{Daftar}
\begin{eulercomment}
...
\end{eulerprompt}
\begin{eulercomment}
Berkasnya terlihat seperti ini 
\end{eulercomment}
\begin{eulerprompt}
>printfile(file)
\end{eulerprompt}
...
\end{eulerprompt}
\eulerimg{15}{images/22305144006_EMT4Statistika-049.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/22305144006_EMT4Statistika-053.png}
\begin{eulercomment}
2. Diketahui sebuah data hasil nilai Ujian Akhir Semester mata kuliah
